...
class Client():
    def __init__(self, nick, port=20201, max_clients=5):
        self.nickname = nick
    ...
    def connect(self,ip, port):
        ...
        self.clients_socket[client_index].settimeout(5)
        ...
        while True:
            try:
                ...
                if index is not None:
                    ...
                    if addr[0] not in self.clients_ip:
    ...
    def close_connection(self):
        ...
        for socket_ in self.clients_socket:
            socket_.close()
